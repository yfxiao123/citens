...
by ``litreview sjr`` at setup time, never redistributed with the package).
...
from litreview.models import ScoredPaper
...
def convert_rda_to_csv(rda_path: str | Path, csv_path: str | Path) -> int:
    ...
    import pyreadr  # lazy: only needed by `litreview sjr`
